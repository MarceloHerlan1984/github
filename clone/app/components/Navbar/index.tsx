      ...
      <div className="py-5 text-white bg-transparent">
        <div className="flex items-center max-lg:justify-between max-lg:flex-row-reverse">
          <div className="flex items-center justify-between max-lg:w-full">
            ...
            <button type="button" onClick={() => setShowNav(!showNav)} className="cursor-pointer lg:hidden">
              <div
                className={`w-[23px] h-[2px] transition ease-in duration-155 bg-white mb-1 ${
                  showNav ? "rotate-45 mb-0 translate-y-[1px] " : "rotate-0 mb-1"
                }`}></div>
              <div className={`w-[23px] h-[2px] transition ease-in duration-155 bg-white mb-1 ${showNav ? "hidden mb-0" : " mb-1"}`}></div>
              <div
                className={`w-[23px] h-[2px] transition ease-in duration-155 bg-white ${showNav ? "-rotate-45 mb-0" : "rotate-0"}`}></div>
            </button>
          </div>
          <div
            ...
            <div className="flex max-lg:flex-col lg:items-center lg:justify-between max-lg:justify-between max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:w-full max-lg:max-h-[500px]  overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg">
              <nav className="px-3 mt-0 lg:px-6 text-[15.5px] mb-0 max-lg:py-10 max-lg:px-5">
                <ul className="flex overflow-y-auto lg:items-center lg:space-x-2 max-lg:flex-col max-lg:text-neutral-700 max-lg:text-xl max-lg:font-medium max-lg:space-y-6 max-lg:h-auto">
                  ...
                  <OpenSourceNav />
                  <li>
                    <a className="flex items-center p-1 max-lg:font-semibold hover:text-neutral-300">Pricing</a>
                  </li>
                </ul>{" "}
              </nav>
