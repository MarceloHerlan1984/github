      ...
      <div className="flex">
          ...
          <div className="mx-auto my-3 ">
            <span className="relative z-[11]">
              ...
              <span
                ...
                style={{ backgroundColor: "var(--mktg-accent-primary)", filter: "blur(17px)" }}></span>
            </span>
          </div>
          <div
            style={{ background: "linear-gradient(#d2a8ff, #a371f7 10%, #196c2e 70%, #2ea043 80%, #56d364)", marginLeft: "11px" }}
            className=" max-md:w-[2px] w-[3px] h-[450px] max-md:h-[650px] max-sm:h-[750px]  line rounded-md"></div>
        </div>
        <div className="absolute pt-32 ml-4 mt-28 max-md:px-4 md:ml-12">
          ...
          <p className="relative z-1 text-[24px] md:text-[28px]  lg:text-[32px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12  lg:w-9/12 text-[#7d8590]">
            Harnessed for productivity. Designed for collaboration. Celebrated for built-in security. Welcome to the platform
            developers&nbsp;love.
          </p>
